...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, SKR-mini-E3_v1.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "My Ender2"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "d9b44d85-0fbe-42ea-901d-d330a14e225d"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  16.46,  16.46 }
    #define DEFAULT_Ki_LIST {   0.83,   0.83 }
    #define DEFAULT_Kd_LIST {  62.90,  62.90 }
  #else
    #define DEFAULT_Kp  16.46
    #define DEFAULT_Ki   0.83
    #define DEFAULT_Kd  62.90
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT     { 160, 160, 800, 420 } // 1/32, 1/32, 1/32, 1/32(BMG) STEPS
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 20, 100 } // 50 for 'normal' extruder
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 32, -2, -3.4 }
...
#define X_BED_SIZE 165 // 165 physikalisch
#define Y_BED_SIZE 165 // 165 physikalisch

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0 // 7 (2)
#define Y_MIN_POS 0 // 7 (0) // 10
#define Z_MIN_POS 0
...
//
#define PREHEAT_1_LABEL       "TPU/TPE"

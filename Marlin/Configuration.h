 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // Default: 0

/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT_2 0 // Default: -1
...
#define CUSTOM_MACHINE_NAME "Opiswahn's A8"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "f08b1e3a-f2c0-4438-b1e6-e110297a11eb"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // ANET A8 Standard Extruder at 245 Degree Celsius and 100% Fan
  //(measured after M106 with M303 E0 S245 C8)
  #define DEFAULT_Kp 20.62 // 13.86
  #define DEFAULT_Ki 1.35// 0.77
  #define DEFAULT_Kd 78.95// 62.10
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 25.69 //650.00
  #define DEFAULT_bedKi 1.90 //150.00
  #define DEFAULT_bedKd 231.75 //400.00
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 920 } // 0.4er Nozzle
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 860 } // 0.5er Nozzle
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.035  // 0.035 (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -5, 22, -2.1 }
...
#define BED_CENTER_AT_110_110 // #define BED_CENTER_AT_130_120
...
#define PREHEAT_2_LABEL       "TPU/TPE"
